...
//console.log(cat);
if (cat == 'N'.toLocaleLowerCase() || cat == 'NO'.toLocaleLowerCase()) { alert('you got it right ') }
...
else { alert('please try for the next time ') }
...
cat.toLowerCase();
switch (cat) {//hoon ba7ot bel case small letters la2no hala2 kol shi 7ayd5ol 3aliha 7aykon t7awal la small
